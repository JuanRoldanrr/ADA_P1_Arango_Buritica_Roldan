...
datos = [
    {"clave": "ijax",   "alfabeto": "A1", "n": 4, "fb_eval": 146716,    "fb_ms": 660.302,   "dic_eval": 28},
    {"clave": "ans9",   "alfabeto": "A2", "n": 4, "fb_eval": 17532,     "fb_ms": 85.648,    "dic_eval": 204},
    {"clave": "uxyby",  "alfabeto": "A1", "n": 5, "fb_eval": 9560043,   "fb_ms": 44015.7,   "dic_eval": 227},
    {"clave": "r0la7",  "alfabeto": "A2", "n": 5, "fb_eval": 29780818,  "fb_ms": 137123.0,  "dic_eval": 389},
    {"clave": "wpctwv", "alfabeto": "A1", "n": 6, "fb_eval": 268293502, "fb_ms": 1248450.0,"dic_eval": 337},
]

# Gráfica 1: tiempo de ejecución vs. n
fig, ax = plt.subplots()
for alfabeto in ["A1", "A2"]:
    serie = [d for d in datos if d["alfabeto"] == alfabeto]
    ax.plot([d["n"] for d in serie], [d["fb_ms"] for d in serie],
            marker="o", label=alfabeto)
    for d in serie:
...
# Gráfica 2: candidatos evaluados vs. n
fig, ax = plt.subplots()
for alfabeto in ["A1", "A2"]:
    serie = [d for d in datos if d["alfabeto"] == alfabeto]
...
# Gráfica 3: Fuerza Bruta vs. diccionario
...
ax.set_ylabel("Candidatos evaluados")
ax.set_title("Candidatos evaluados: Fuerza Bruta vs. Diccionario")
ax.set_yscale("log")
